...
import 'package:dualites/shared/fonts/tik_tok_icons_icons.dart';
import 'package:flutter/material.dart';

class ActionsToolbar extends StatelessWidget {
  final VideoModel videoModel;
  ActionsToolbar({this.videoModel});
...
// The size of the plus icon under the profile image in follow action
  ...
  Widget _getSocialAction({String title, IconData icon, bool isShare = false}) {
    if(icon==TikTokIcons.heart){
      return LikeWidget(videoModel: videoModel);
    }
    return Container(
